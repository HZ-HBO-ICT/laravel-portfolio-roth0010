...
@section('content')
<h1 id="welcome">Blog 7: The Pitch</h1>
<h4>10 October 2021</h4>
<article class="journey-art">
    <div class="journey-text">
        <h4>The First Pitch</h4>
        <p>
            ...
            the hypocrite, as this edition of the website lacked style in much the same way. The philosophy behind
...
@section('citation')
    <p>Superbock. Flickr. "NS 9504 Tilburg 1 augustus 2021"
        "https://www.flickr.com/photos/superbock/51354309063/in/pool-emurail/"
    </p>
@endsection
